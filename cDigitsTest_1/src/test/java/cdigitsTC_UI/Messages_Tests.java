...
/*
 * UI_43807_CheckMessagetab_Scroll
 * 
 * 
 */
public class Messages_Tests extends base {

	public static final Logger log = Logger.getLogger(Calls_Tests.class);

	//43807 Check messaging
	@Test
	public void UI_43807_CheckMessagesTabScroll() throws Exception {


		log.info("Test UI_43807_CheckMessagesTabScroll - Started");
		...
		while (scrollDown) {
			...
			Point firstSwipe = msgScroll.SwipeList.get(0).getLocation();
		...
		log.info("Test UI_43807_CheckMessagesTabScroll - Completed");
	}
